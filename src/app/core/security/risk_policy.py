...
class RiskAssessment:
    def __init__(self, level: RiskLevel, reason: str, requires_auth: str = "none", override_response: Optional[str] = None, should_panic: bool = False):
        self.level = level
        self.reason = reason
        ...
        if tool_name in ["read_file", "write_file", "edit_file", "list_dir"]:
            ...
            if tool_name in ["write_file", "edit_file"]:
                 ...
                 if content:
                     ...
                     if pii_findings:
                         return RiskAssessment("medium", f"DLP: PII detected in write content.", "simple")
